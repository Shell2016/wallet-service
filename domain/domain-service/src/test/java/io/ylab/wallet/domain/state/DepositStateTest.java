...
class DepositStateTest {
    ...
    private final State state = new DepositState(applicationService);
    ...
    @Test
    void processInputTransaction() {
        when(applicationService.processTransaction(TRANSACTION_ID, TransactionType.DEPOSIT, AMOUNT))
